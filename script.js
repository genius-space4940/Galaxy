...
let item_descriptions = document.querySelectorAll('.merch-item-descr')
for (let i = 0; i < 4; i += 1) {
    item_descriptions[i].innerHTML = descriptions[i]
}

let prices = [1000, 1000, 2500, 5000]
let item_prices = document.querySelectorAll('.merch-item-price')
for (let i = 0; i < 4; i += 1) {
    item_prices[i].innerHTML = prices[i]
}
